/*
Code is taken from : https://rosettacode.org/wiki/Matrix_chain_multiplication#Java
 */

package DynamicProgrammingSolutions;
import java.util.Arrays;

public class Naiv_dynamicMCP_2 {

    public static void main(String[] args) {
        runMatrixChainMultiplication(new int[] {10,2,5,7,4});
